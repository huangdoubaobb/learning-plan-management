...
// node_modules/vue-data-ui/dist/useSvgExport-ByUukOZt.js
var et = "http://www.w3.org/2000/svg";
var yt = "http://www.w3.org/1999/xlink";
var Bt = 'system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", "Liberation Sans", sans-serif';
...
function Ot({
  ...
  function dt(e, o, h, u, c) {
    ...
    const t = {
      ...
      bold: !!v.value.bold,
      textAlign: (((_a = v.value) == null ? void 0 : _a.textAlign) || "center").toLowerCase(),
    ...
    for (const s of V) {
      ...
      for (let m = 0; m < s.items.length; m += 1) {
        ...
        for (const p of d.lines) {
          const tt = P("tspan");
          mt || tt.setAttribute("dy", String(t.lineHeight)), tt.setAttribute("x", String(H)), tt.textContent = p, Y.appendChild(tt), mt = false;
        }
...
${new XMLSerializer().serializeToString(o)}`, c = new Blob([u], { type: "image/svg+xml;charset=utf-8" }), t = URL.createObjectURL(c), S = `data:image/svg+xml;charset=utf-8,${encodeURIComponent(u)}`;
  ...
  async function ft(e) {
    var _a;
    const { url: o } = await Z(), h = e || ((_a = v.value) == null ? void 0 : _a.text) || "chart", u = document.createElement("a");
  ...
  const lt = (b) => ["div", "p", "span", "strong", "em", "b", "i", "br"].includes(b), nt = (b) => {
    ...
    try {
      ...
      for (; y.length; ) {
        ...
        if (!lt(z) || ((_a = $.querySelector) == null ? void 0 : _a.call($, "img,svg,canvas,video,foreignObject")))
          return false;
  ...
  function W(b) {
    ...
    try {
      ...
      if (!Number.isFinite(L) || L <= 0) {
        const n = (_a = b.getBBox) == null ? void 0 : _a.call(b);
        L = Math.max(1, y(n == null ? void 0 : n.width, 0));
      }
      const O = (n, r) => {
        ...
        const i = gt(n);
        let s = i.getPropertyValue("font-family") || (r == null ? void 0 : r.ff) || "system-ui";
        s = wt(s);
        let a = parseFloat(i.getPropertyValue("font-size"));
        Number.isFinite(a) || (a = (r == null ? void 0 : r.fs) || 14);
        const l = i.getPropertyValue("font-weight") || (r == null ? void 0 : r.fw) || "400", m = i.getPropertyValue("font-style") || (r == null ? void 0 : r.fsty) || "normal", d = i.getPropertyValue("font-stretch") || (r == null ? void 0 : r.fstc) || "normal", k = i.getPropertyValue("letter-spacing") || (r == null ? void 0 : r.lsp) || "normal", g = i.getPropertyValue("word-spacing") || (r == null ? void 0 : r.wsp) || "0px", x = i.getPropertyValue("font-kerning") || (r == null ? void 0 : r.kern) || "auto", _ = i.getPropertyValue("font-variant-ligatures") || (r == null ? void 0 : r.liga) || "normal", H = i.getPropertyValue("text-transform") || (r == null ? void 0 : r.ttfm) || "none", Q = i.getPropertyValue("color") || (r == null ? void 0 : r.fill) || "#000", Y = i.getPropertyValue("line-height"), mt = !Y || Y.trim().toLowerCase() === "normal" ? (r == null ? void 0 : r.lh) ?? Math.round(a * 1.2) : O(Y, a), p = (i.getPropertyValue("text-align") || (r == null ? void 0 : r.ta) || "start").trim().toLowerCase();
      ...
      }, dt = (n) => /^(div|p|section|article|ul|ol|li|h[1-6])$/.test(n), q = { __para__: true }, ht = { __br__: true }, B = [], K = st(f), ct = (n, r, i) => {
        if (n.nodeType === 3) {
      ...
      const J = () => {
        ...
        if (i) {
          const a = X(r);
          s += a, T.push({ text: " ", ...r, w: a, isSpace: true });
        }
        ...
        const r = n.style, i = n.text.split(/(\s+)/).filter((l) => l.length > 0), s = (l, m) => {
          ...
          if (T.length === 0)
            if (k <= d)
              ...
              for (; g; ) {
                const x = V(g, r, d);
                E(x, r, false), g = g.slice(x.length), g && J();
              }
            }
          else if (R + k <= d)
            E(l, r, m);
      ...
      for (let n = 0; n < D.length; n += 1) {
        ...
        for (const a of r) {
          ...
          s && (l.setAttribute("x", String(t)), n > 0 && l.setAttribute("dy", String(i)), s = false), l.setAttribute("style", `${C(a)} fill:${a.fill};`), l.textContent = a.text, w.appendChild(l);
        }
        if (!r.length && n > 0) {
...
//# sourceMappingURL=chunk-U57Z6XZ6.js.map
