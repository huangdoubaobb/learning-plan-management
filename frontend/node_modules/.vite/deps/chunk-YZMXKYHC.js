...
// node_modules/vue-data-ui/dist/lib-GwPnJSrY.js
var At = "#COMP# dataset prop is either missing, undefined or empty.";
var yt = "#COMP# dataset is missing the '#ATTR#' attribute.";
var xt = "#COMP# dataset '#ATTR#' attribute cannot be empty.";
var bt = "#COMP# dataset #KEY# item at index #INDX# is missing the '#ATTR#' attribute.";
var Ct = "#COMP# : Chart could not be built. Dataset is not formatted correctly";
var Mt = "#COMP# : A wrong value was provided to the #ATTR# attribute (#KEY# is not a valid value).";
var $t = {
  dataset: At,
  datasetAttribute: yt,
...
function tt([t, n], [e, s], [r, o], c, i = 360, l = 2, a = false) {
  o = o % (l * Math.PI);
  const u = Dt(c), [f, h] = ut(
    lt(u, [
      e * Math.cos(r),
...
function mt(t) {
  ...
  if (t == null || typeof t == "number" && isNaN(t))
    return null;
  if (t = ((_a = isRef) == null ? void 0 : _a(t)) ? unref(t) : t, t = Vt(t), Array.isArray(t)) {
    const [l, a, u, f = 1] = t;
    t = `rgba(${l},${a},${u},${f})`;
...
function st(t, n = /* @__PURE__ */ new WeakSet()) {
  ...
  n.add(e);
  for (const s in e) {
    const r = isRef(e[s]) ? unref(e[s]) : e[s];
...
function yn(t, n = 0.2) {
  ...
  function r(c, i, l) {
    const a = s(l[i - 1], l[i - 2], c), u = s(c, l[i - 1], l[i + 1], true);
...
function _(t, n = false, e = 16, s = false) {
...
function Cn(t, n = false, e = 16, s = 16, r = false, o = false, c = 0, i = 12, l = false) {
...
function In(t, n, e, s = false) {
  const r = s ? n - t : q(n - t, false), o = s ? r / (e - 1) : q(r / (e - 1), true), c = Math.floor(t / o) * o, i = Math.ceil(n / o) * o, l = [];
  for (let a = c; a <= i; a += o)
    l.push(a);
  return {
    min: c,
...
function Ln(t, n, e, s = false) {
  const r = s ? n - t : q(n - t, false), o = s ? r / (e - 1) : q(r / (e - 1), true), c = Math.floor(t / o) * o, i = Math.ceil(n / o) * o;
  let l = [], a = c;
  for (; a <= i; )
...
function wn({ p: t = "", v: n, s: e = "", r: s = 0, space: r = false, isAnimating: o = false, regex: c = /[^%]/g, replacement: i = "-", locale: l = null }) {
...
function Yn(t) {
  return Array.isArray(t) ? t.length === 0 : t ? Object.keys(t).length === 0 : true;
}
function Hn({ componentName: t, type: n, property: e = "", index: s = "", key: r = "", warn: o = true, debug: c = true }) {
  if (!c) return;
  const i = `
...
function Vt(t) {
  var _a;
  const n = ((_a = isRef) == null ? void 0 : _a(t)) ? unref(t) : t;
...
function jn({ content: t, fontSize: n, fill: e, x: s, autoOffset: r = false }) {
  const o = t.split(`
...
function _t(t, { value: n, config: e }) {
  ...
  if (typeof t == "function")
    try {
      r = t({ value: n, config: e }), ["number", "string"].includes(typeof r) ? s = true : r = n;
    } catch (o) {
      console.warn("Formatter could not be applied:", o), s = false;
    }
  return {
    isValid: s,
    value: r
...
function Jn(t, n) {
  return n.split(".").every((e) => t !== null && typeof t == "object" && e in t ? (t = t[e], true) : false);
}
function te(t, n = [], e = false) {
  function s(o) {
...
function ee({ series: t, center: n, maxRadius: e, hasGhost: s = false }) {
...
function pe(t, n, e = false, s = true) {
  function r(c) {
    const i = [];
    let l = [];
    for (const a of c)
...
function Me(t) {
  ...
  function g(x, $) {
    ...
    for (const B of C) {
      ...
      P == null ? w.push({ x: B, y: null, hole: true }) : w.push({ x: B, y: P, hole: false });
    }
    return w;
  }
  function p(x, $, M) {
  ...
  function m(x, $) {
    ...
    for (let I = 0; I < y - 1; I += 1) {
      ...
      if (T > 0 && O < 0 || T < 0 && O > 0) {
        const Y = T / (T - O), H = p(C.x, w.x, Y), R = p(C.y, w.y, Y), k = { x: H, y: R, hole: false }, U = { x: H, y: R, hole: false };
        M.push(k), D.push(U);
      }
    }
...
function $e(t, n, e = {}) {
  const r = { ...{ bubbles: true, cancelable: true, composed: true }, ...e }, o = /* @__PURE__ */ new Set([
    "click",
    "mousedown",
    "mouseup",
    "mousemove",
...
function De(t, { delta: n = 1, delay: e = 20, disableTransitions: s = true } = {}) {
...
//# sourceMappingURL=chunk-YZMXKYHC.js.map
