// node_modules/vue-data-ui/dist/vue_ui_history_plot-BCKk1CrQ.js
var o = { userOptions: { show: false }, style: { chart: { legend: { show: false }, grid: { horizontalLines: { show: false }, verticalLines: { show: false } } } } };
var l = { userOptions: { show: false }, table: { th: { backgroundColor: "#1A1A1A", color: "#CCCCCC" }, td: { backgroundColor: "#1A1A1A", color: "#CCCCCC" } }, style: { chart: { backgroundColor: "#1A1A1A", color: "#CCCCCC", title: { color: "#CCCCCC", subtitle: { color: "#757575" } }, tooltip: { backgroundColor: "#1A1A1A", backgroundOpacity: 70, color: "#CCCCCC", borderColor: "#3A3A3A" }, legend: { show: false, backgroundColor: "#1A1A1A", color: "#CCCCCC", selectAllToggle: { backgroundColor: "#3A3A3A", color: "#CCCCCC" } }, grid: { xAxis: { stroke: "#5A5A5A" }, horizontalLines: { show: false, stroke: "#4A4A4A" }, yAxis: { stroke: "#5A5A5A" }, verticalLines: { show: false, stroke: "#4A4A4A" } }, axes: { x: { labels: { color: "#CCCCCC" }, name: { color: "#CCCCCC" } }, y: { labels: { color: "#CCCCCC" }, name: { color: "#CCCCCC" } } }, plots: { stroke: "#1A1A1A", labels: { color: "#CCCCCC" } } } } };
...
//# sourceMappingURL=chunk-R7GXY4TR.js.map
